    ...
    <>
      <div className="flex flex-row justify-center my-6">
        <div className="flex flex-row w-3/4 items-center justify-center space-x-4">
          ...
          <UilLocationPoint size={25} className="text-white cursor-pointer transition ease-out hover:scale-110"/>
        </div>
        <div className="flex flex-row w-1/4 items-center justify-center">
          <button name="metric" className="text-white text-xl"> &#176;C</button>
          <p className="text-xl text-white mx-1">I</p>

          <button name="imperial" className="text-white text-xl">&#176;F</button>
          <p></p>
        </div>
      </div>
    </>
